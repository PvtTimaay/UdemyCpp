...
int main()
{
    ...
    const auto mean_array_a = computation::mean_array_value(array_a, array_elements);
    const auto mean_array_b = computation::mean_array_value(array_b, array_elements);
